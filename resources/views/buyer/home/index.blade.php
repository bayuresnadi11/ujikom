    ...
    <div class="mobile-container" id="mobileContainer">
        ...
        <main class="main-content">
            ...
            <div class="venue-section">
                <h2 class="venue-title">Punya Lapangan Olahraga?</h2>
                <p class="venue-desc">
                    Gabung jadi mitra SewaLap dan kelola booking lapangan dengan lebih mudah.
                    Jangkau lebih banyak pelanggan, atur jadwal fleksibel, dan tingkatkan
                    pendapatan lewat sistem kemitraan kami.
                </p>
                <button class="btn-venue" onclick="window.location.href='{{ route('register') }}'">
                    Gabung sebagai Mitra Venue →
                </button>
            </div>
