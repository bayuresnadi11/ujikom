    ...
    <div class="otp-container">
        <div class="otp-card">
            <div class="otp-header">
                ...
                <p class="otp-subtitle">Konfirmasi penarikan saldo Anda</p>
            </div>
            ...
            <div class="otp-body">
                ...
                <form action="{{ route('buyer.deposit.withdraw.verify-otp') }}" method="POST">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-verify">
                        <i class="bi bi-check-circle me-2"></i>
                        Verifikasi & Proses Withdraw
                    </button>
                </form>

                <form action="{{ route('buyer.deposit.withdraw.resend-otp') }}" method="POST">
                    @csrf
