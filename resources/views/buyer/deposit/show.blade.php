    ...
    <div class="mobile-container">
        ...
        <main class="main-content">
            ...
            @if ($deposit->status === 'pending')
                ...
                <!-- Action Buttons -->
                <div class="payment-container">
                    <form action="{{ route('buyer.deposit.confirm', $deposit->id) }}" method="POST" style="margin-bottom: 12px;">
                        @csrf
                    ...
                    <form action="{{ route('buyer.deposit.cancel', $deposit->id) }}" method="POST">
                        @csrf
                        @method('PATCH')
            ...
            @elseif ($deposit->status === 'completed')
                <div class="payment-container">
                    ...
                    <a href="{{ route('buyer.deposit.index') }}" class="btn btn-primary" style="display: block;">
            ...
            @else
                <div class="payment-container">
                    ...
                    <a href="{{ route('buyer.deposit.index') }}" class="btn btn-primary" style="display: block; margin-top: 16px;">
                        <i class="fas fa-arrow-left"></i>
                        Kembali ke Saldo
                    </a>
                </div>
