...
/* ================ VARIABLES AND YOUR MAIN_BARENG CSS ================ */
/* ... lanjutkan dengan CSS variabel dan main_bareng Anda yang sudah ada ... */
        /* ================ VARIABLES ================ */
        :root {
            --primary: #0A5C36;
            --primary-dark: #08472a;
        ...
        * {
        ...
        /* Tambahkan search bar seperti di Booking */
        .search-bar {
            padding: 12px 16px;
            background: rgba(255, 255, 255, 0.1);
        }
